...
![Pasted_image_20260603101851.png]
...
![Pasted_image_20260603113413.png]
...
Copy the `link/ether` value and paste it into the `hardware ethernet` line in `dhcpd.conf` on Server 1.
...
![Pasted_image_20260603121153.png]
...
![Pasted_image_20260603121644.png]

#### Troubleshooting - Server 2 Gets a Dynamic IP Instead of the Reserved Address

After the first test, Server 2 received `192.168.56.151` (from the dynamic range) instead of the expected `192.168.56.120` (the static reservation). This happens when the MAC address in `dhcpd.conf` does not match the actual MAC of the machine.
...
![Pasted_image_20260603123916.png]
...
![Pasted_image_20260603124514.png]
...
On AlmaLinux 9, NetworkManager stores lease data in `/var/lib/NetworkManager/` rather than the old `/var/lib/dhclient/` path:
...
![Pasted_image_20260603125306.png]
...
![Pasted_image_20260603130818.png]
